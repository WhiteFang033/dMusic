...
const ExploreItems = ({index, title, artist, songSource, setSongArray}) => {
  ...
  return (
    <div onMouseOver={()=>{setCursorStatus(true)}} onMouseOut={()=>{setCursorStatus(false)}} className="flex w-[45%] h-[70px] bg-zinc-900 rounded-xl px-5 my-2 items-center border-2 border-zinc-900 justify-between hover:bg-purple-700 hover:border-purple-700 transition-all delay-75">
